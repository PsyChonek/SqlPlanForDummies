...
<template>
  <div class="relative w-full h-full bg-slate-900 rounded-2xl shadow-2xl">
    <!-- Header bar -->
    <div class="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-slate-800/90 backdrop-blur border-b border-slate-700">
